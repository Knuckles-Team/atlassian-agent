...
**For Confluence pages:**
```
**Source:** [Page Title]([configured-endpoint])
```

**For Jira issues:**
```
**Related Tickets:**
- [PROJ-123]([configured-endpoint]) - Brief description
- [PROJ-456]([configured-endpoint]) - Brief description
```
...
- [Stratus Architecture Guide]([configured-endpoint])
- [Minion Configuration]([configured-endpoint])

**Jira Issues:**
- [PROJ-145]([configured-endpoint]) - Minion scaling implementation
- [PROJ-203]([configured-endpoint]) - Performance optimization
