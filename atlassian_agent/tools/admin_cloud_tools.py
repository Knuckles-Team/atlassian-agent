...
def register_admin_cloud_tools(mcp: FastMCP):
    ...
    def admin_cloud_get_directory_users(
        ...
        api = get_api()
        response = api.admin_cloud_get_directory_users(
            directory_id=directory_id, org_id=org_id
        )
        return response.model_dump()
    ...
    def admin_cloud_get_directory_users_count(
        ...
        api = get_api()
        response = api.admin_cloud_get_directory_users_count(
            directory_id=directory_id, org_id=org_id
        )
        return response.model_dump()
    ...
    def admin_cloud_get_user_stats(
        ...
        api = get_api()
        response = api.admin_cloud_get_user_stats(
            directory_id=directory_id, org_id=org_id
        )
        return response.model_dump()
    ...
    def admin_cloud_get_groups(
        ...
        api = get_api()
        response = api.admin_cloud_get_groups(directory_id=directory_id, org_id=org_id)
        return response.model_dump()
    ...
    def admin_cloud_get_groups_count(
        ...
        api = get_api()
        response = api.admin_cloud_get_groups_count(
            directory_id=directory_id, org_id=org_id
        )
        return response.model_dump()
    ...
    def admin_cloud_get_groups_stats(
        ...
        """Get group stats"""
        api = get_api()
        response = api.admin_cloud_get_groups_stats(
            directory_id=directory_id, org_id=org_id
        )
        return response.model_dump()
