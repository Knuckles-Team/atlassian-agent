...
def register_jira_other_tools(mcp: FastMCP):
    ...
    def jira_cloud_get_all_gadgets(
        ...
        module_key: list[Any] | None = Field(
            None,
    ...
    def jira_cloud_get_policy(_ctx: Context | None = None) -> dict[str, Any]:
    ...
    def jira_cloud_get_events(_ctx: Context | None = None) -> dict[str, Any]:
        """Get events"""
        api = get_api()
    ...
    def jira_cloud_get_options_for_context(
        ...
        option_id: int | None = Field(None, description="The ID of the option."),
        only_options: bool | None = Field(
    ...
    def jira_cloud_get_license(_ctx: Context | None = None) -> dict[str, Any]:
        """Get license"""
        api = get_api()
    ...
    def jira_cloud_get_auto_complete(_ctx: Context | None = None) -> dict[str, Any]:
    ...
    def jira_cloud_get_precomputations(
        function_key: list[Any] | None = Field(
            None,
    ...
    def jira_cloud_update_precomputations(
        skip_not_found_precomputations: bool | None = Field(
    ...
    def jira_cloud_get_locale(_ctx: Context | None = None) -> dict[str, Any]:
        """Get locale"""
        api = get_api()
    ...
    def jira_cloud_get_priorities(_ctx: Context | None = None) -> dict[str, Any]:
        """Get priorities"""
        api = get_api()
    ...
    def jira_cloud_get_server_info(_ctx: Context | None = None) -> dict[str, Any]:
    ...
    def jira_cloud_get_default_editor(_ctx: Context | None = None) -> dict[str, Any]:
