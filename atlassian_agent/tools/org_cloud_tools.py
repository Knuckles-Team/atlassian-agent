...
def register_org_cloud_tools(mcp: FastMCP):
    ...
    def org_cloud_get_org_by_id(_ctx: Optional[Context] = None) -> Dict[str, Any]:
        """Get an organization by ID"""
        api = get_api()
        response = api.org_cloud_get_org_by_id()
        return response.model_dump()

    @mcp.tool(name="org_cloud_get_directory_users", tags={"atlassian-org"})
    def org_cloud_get_directory_users(_ctx: Optional[Context] = None) -> Dict[str, Any]:
    ...
    def org_cloud_get_user_stats(_ctx: Optional[Context] = None) -> Dict[str, Any]:
    ...
    def org_cloud_get_groups(_ctx: Optional[Context] = None) -> Dict[str, Any]:
        """Get groups in an organization"""
        api = get_api()
        response = api.org_cloud_get_groups()
        return response.model_dump()
    ...
    def org_cloud_get_group(_ctx: Optional[Context] = None) -> Dict[str, Any]:
        """Get group details"""
        api = get_api()
    ...
    def org_cloud_get_groups_count(_ctx: Optional[Context] = None) -> Dict[str, Any]:
    ...
    def org_cloud_get_groups_stats(_ctx: Optional[Context] = None) -> Dict[str, Any]:
        """Get group stats"""
        api = get_api()
    ...
    def org_cloud_get_directories_for_org(
        ...
        api = get_api()
        response = api.org_cloud_get_directories_for_org()
        return response.model_dump()
    ...
    def org_cloud_get_event_actions(_ctx: Optional[Context] = None) -> Dict[str, Any]:
        """Get list of event actions"""
        api = get_api()
        response = api.org_cloud_get_event_actions()
        return response.model_dump()
