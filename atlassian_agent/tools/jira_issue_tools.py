...
def register_jira_issue_tools(mcp: FastMCP):
    ...
    def jira_cloud_get_attachment_thumbnail(
        ...
        fallback_to_default: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_replace_issue_field_option(
        ...
        override_screen_security: Optional[bool] = Field(
            None,
        ...
        override_editable_flag: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_create_filter(
        ...
        override_share_permissions: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_get_my_filters(
        ...
        include_favourites: Optional[bool] = Field(
    ...
    def jira_cloud_get_filters_paginated(
        ...
        is_substring_match: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_bulk_get_groups(
        ...
        group_id: Optional[List[Any]] = Field(
            None,
        ...
        group_name: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_get_create_issue_meta(
        ...
        project_keys: Optional[List[Any]] = Field(
            None,
        ...
        issuetype_ids: Optional[List[Any]] = Field(
            None,
        ...
        issuetype_names: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_get_issue_limit_report(
        is_returning_keys: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_get_issue_picker_resource(
        ...
        show_sub_tasks: Optional[bool] = Field(
            None,
            description="Indicate whether to include subtasks in the suggestions list.",
        ),
        show_sub_task_parent: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_get_issue(
        ...
        fields_by_keys: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_edit_issue(
        ...
        return_issue: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_get_transitions(
        ...
        skip_remote_only_condition: Optional[bool] = Field(
            None,
        ...
        include_unavailable_transitions: Optional[bool] = Field(
            None,
            description="Whether details of transitions that fail a condition are included in the response",
        ),
        sort_by_ops_bar_and_status: Optional[bool] = Field(
            None,
    ...
    def jira_cloud_get_issue_security_level_members(
        ...
        issue_security_level_id: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_delete_issue_type(
        ...
        alternative_issue_type_id: Optional[str] = Field(
    ...
    def jira_cloud_get_issue_type_schemes_mapping(
        ...
        issue_type_scheme_id: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_get_issue_type_screen_scheme_mappings(
        ...
        issue_type_screen_scheme_id: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_get_projects_for_issue_type_screen_scheme(
        ...
        query: Optional[str] = Field(None, description="Parameter query"),
        _ctx: Optional[Context] = None,
    ) -> Dict[str, Any]:
    ...
    def jira_cloud_get_bulk_screen_tabs(
        screen_id: Optional[List[Any]] = Field(
            None,
        ...
        tab_id: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_search_for_issues_using_jql(
        ...
        validate_query: Optional[str] = Field(
            None,
    ...
    def jira_cloud_search_and_reconsile_issues_using_jql(
        ...
        reconcile_issues: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_bulk_get_users(
        ...
        username: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_get_workflow_transition_rule_configurations(
        ...
        workflow_names: Optional[List[Any]] = Field(
            None, description="The list of workflow names to filter by."
        ),
        with_tags: Optional[List[Any]] = Field(
    ...
    def jira_cloud_get_workflow_transition_properties(
        ...
        include_reserved_keys: Optional[bool] = Field(
            None,
