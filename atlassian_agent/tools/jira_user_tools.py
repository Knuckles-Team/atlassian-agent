...
def register_jira_user_tools(mcp: FastMCP):
    ...
    def jira_cloud_remove_group(
        groupname: Optional[str] = Field(None, description="Parameter groupname"),
        ...
        swap_group_id: Optional[str] = Field(
            None,
    ...
    def jira_cloud_get_group(
        ...
        expand: Optional[str] = Field(None, description="List of fields to expand."),
        _ctx: Optional[Context] = None,
    ) -> Dict[str, Any]:
        """Get group"""
        api = get_api()
    ...
    def jira_cloud_get_users_from_group(
        ...
        include_inactive_users: Optional[bool] = Field(
    ...
    def jira_cloud_find_groups(
        ...
        exclude_id: Optional[List[Any]] = Field(
            None,
    ...
    def jira_cloud_find_users_and_groups(
        ...
        issue_type_id: Optional[List[Any]] = Field(
            None,
        ...
        avatar_size: Optional[str] = Field(
            None,
    ...
    def jira_cloud_get_my_permissions(
        ...
        project_id: Optional[str] = Field(None, description="The ID of project."),
        ...
        project_uuid: Optional[str] = Field(None, description="Parameter projectUuid"),
        project_configuration_uuid: Optional[str] = Field(
    ...
    def jira_cloud_find_assignable_users(
        ...
        recommend: Optional[bool] = Field(None, description="Parameter recommend"),
        account_type: Optional[List[Any]] = Field(
            None, description="Parameter accountType"
        ),
        app_type: Optional[List[Any]] = Field(None, description="Parameter appType"),
        _ctx: Optional[Context] = None,
    ) -> Dict[str, Any]:
    ...
    def jira_cloud_find_users_with_all_permissions(
        ...
        issue_key: Optional[str] = Field(
            None, description="The issue key for the issue."
        ),
        project_key: Optional[str] = Field(
    ...
    def jira_cloud_find_users_for_picker(
        ...
        exclude_account_ids: Optional[List[Any]] = Field(
            None,
        ...
        avatar_size: Optional[str] = Field(None, description="Parameter avatarSize"),
        exclude_connect_users: Optional[bool] = Field(
