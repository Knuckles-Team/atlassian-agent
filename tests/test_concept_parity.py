...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/atlassian-agent"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in atlassian-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in atlassian-agent but are NOT registered "
